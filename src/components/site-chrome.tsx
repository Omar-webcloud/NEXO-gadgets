    ...
    <header className={`site-header ${scrolled ? "site-header-scrolled" : ""}`}>
      <nav className="nav-shell" aria-label="Main navigation">
        ...
        <div className="nav-actions">
          <button className="icon-button" onClick={handleSearchClick} aria-label="Search products">
            <Search size={20} />
          </button>
      ...
      <div className="footer-inner">
        <div className="footer-top">
          <div className="footer-brand">
            <Logo />
            <p>Gear Up. Live Smart. Premium Gadget Shop in Chittagong, Bangladesh.</p>
            <div className="socials">
              <a href="https://www.facebook.com/nexogadg3ts" target="_blank" rel="noopener noreferrer" aria-label="NEXO Gadgets on Facebook" title="NEXO Gadgets Facebook Page">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/nexo_bd" target="_blank" rel="noopener noreferrer" aria-label="NEXO Gadgets on Instagram" title="NEXO Gadgets Instagram Profile">
              ...
              <a href="https://wa.me/8801796073736" target="_blank" rel="noopener noreferrer" aria-label="NEXO Gadgets on WhatsApp" title="NEXO Gadgets WhatsApp">
              ...
              <a href="https://www.tiktok.com/@nexogadg3ts" target="_blank" rel="noopener noreferrer" aria-label="NEXO Gadgets on TikTok" title="NEXO Gadgets TikTok">
              ...
              <a href="https://www.youtube.com/@NEXO-bd" target="_blank" rel="noopener noreferrer" aria-label="NEXO Gadgets on YouTube" title="NEXO Gadgets YouTube">
